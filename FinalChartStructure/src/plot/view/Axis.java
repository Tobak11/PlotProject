...
public class Axis extends Group {
    ...
    private ArrayList<Double> majorTickCoordinates;
    private ArrayList<Line> majorTickLines;
    private ArrayList<Text> majorTickLabels;
    
    private ArrayList<Double> minorTickCoordinates;
    ...
    public Axis(AxisData axisData, AxisType axisType, ArrayList<DataSeries> ds, double xWidth, double yHeight) {
        ...
        if (axisType.equals(AxisType.HORIZONTAL)) {
            ...
            //MAJOR TICK LINES
            majorTickCoordinates = VisualUtility.xTickCoordinateGenerator(Math.abs(tempMax)+Math.abs(tempMin), axisData.getMajorStep(), 8, xWidth, yHeight);
